...
namespace CrystalReportsNinja
{
    public static class Helper
    {
        ...
        public static void ShowHelpMessage()
        {
            ...
            Console.WriteLine("Copyright(c) Rainforest Software Solution http://www.rainforestnet.com");
            ...
            Console.WriteLine("-B To Burst PDF output according to top level grouping");
            Console.WriteLine("---------------------------------------------------");
